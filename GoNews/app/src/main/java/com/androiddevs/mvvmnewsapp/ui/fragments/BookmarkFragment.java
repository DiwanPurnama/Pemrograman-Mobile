...
import com.androiddevs.mvvmnewsapp.databinding.FragmentBookmarkBinding;
import com.androiddevs.mvvmnewsapp.databinding.FragmentBookmarkBinding;
...
public class BookmarkFragment extends Fragment implements NewsAdapter.OnItemClickListener {
...
//                adapter.submitData(getViewLifecycleOwner().getLifecycle(),articles);
        ...
        ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Snackbar.make(getView(), "Berita Telah Dihapus dari Bookmark", Snackbar.LENGTH_SHORT)
    ...
    public void onItemClickListener(Article article) {
        ...
        BookmarkFragmentDirections.ActionBookmarkFragmentToArticleFragment action =
