package com.example.notifictionscheduler;
...
public class MainActivity extends AppCompatActivity {
    ...
    Switch mDeviceIdleSwitch;
    Switch mDeviceChargingSwitch;
    ...
    public void scheduleJob(View view){
        ...
        if(constraintSet){
            ...
            Toast.makeText(this, "Job Scheduled, job will run when " + "the constraint are met.", Toast.LENGTH_SHORT).show();
        }else{
